...
class BankTransferPayment(Payment):
    ...
    def make(self):
        if self._has_balance():
            ...
            print("Você não possuiu saldo em suaconta para realizar a transferência")
...
#foi usada a primeira aula de banco de dados para finalizar OB, para aprender herança e polimorfismo